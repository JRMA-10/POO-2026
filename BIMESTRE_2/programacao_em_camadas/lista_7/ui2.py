...
class UI: 
    ...
    @staticmethod
    def cliente_listar(): 
        for obj in Service.cliente_listar(): st.write(obj)
    @staticmethod
    def cliente_atualizar(): 
        for obj in Service.cliente_listar(): print(obj)
        id = int(st.text_input('Informe o ID a ser atualizado: \n'))
    ...
    def cliente_excluir():
        for obj in Service.cliente_listar(): st.write(obj)
        id = int(st.text_input('Informe o id do cliente a ser excluido: \n'))
    ...
    @staticmethod
    def servico_inserir(): 
        servico = st.text_input('Informe a descricao do servico: \n')
        valor = st.number_input('Informe o valor do serviço: \n')
        Service.servico_inserir(servico, valor)
    @staticmethod
    def servico_listar(): 
        for obj in Service.servico_listar: st.write(obj)
    @staticmethod
